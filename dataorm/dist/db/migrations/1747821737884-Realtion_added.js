...
exports.RealtionAdded1747821737884 = void 0;
class RealtionAdded1747821737884 {
    constructor() {
        this.name = 'RealtionAdded1747821737884';
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            yield queryRunner.query(`CREATE TABLE "address" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "line1" character varying NOT NULL, "pincode" character varying NOT NULL, CONSTRAINT "PK_d92de1f82754668b5f5f5dd4fd5" PRIMARY KEY ("id"))`);
...
exports.RealtionAdded1747821737884 = RealtionAdded1747821737884;
//# sourceMappingURL=1747821737884-Realtion_added.js.map
...
class AuthService {
    ...
    login(email, password) {
        return __awaiter(this, void 0, void 0, function* () {
            const employee = yield this.employeeService.findByEmail(email);
            ...
            const token = jsonwebtoken_1.default.sign(payload, constants_1.JWT_SECERET, { expiresIn: constants_1.JWT_VALIDITY });
            return {
                tokenType: "Bearer",
                accessToken: token
            };

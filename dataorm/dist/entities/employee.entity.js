...
const adress_entity_1 = __importDefault(require("./adress.entity"));
...
__decorate([
    (0, typeorm_1.OneToOne)(() => adress_entity_1.default, (address) => address.employee, {
        cascade: true,
    }),
    __metadata("design:type", adress_entity_1.default)

...
employeeRouter.get("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const employee = yield employeeRepository.find();
...
employeeRouter.get("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // res.status(200).send(employee);
    const employeeRepository = data_source_1.default.getRepository(employee_entity_1.default);
    const employee = yield employeeRepository.findOneBy({ id: req.params.id });
    res.status(200).send(employee);
}));
employeeRouter.post("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    //   .execute()
    const employeeRepository = data_source_1.default.getRepository(employee_entity_1.default);
    const employee = yield employeeRepository.insert({ name: req.body.name, email: req.body.email });
    res.status(200).send(employee);
}));
employeeRouter.delete("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const employeeRepository = data_source_1.default.getRepository(employee_entity_1.default);
    const employee = yield employeeRepository.delete({ id: req.params.id });
    res.status(200).send("Employee deleted" + employee);
}));
employeeRouter.patch("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const employeeRepository = data_source_1.default.getRepository(employee_entity_1.default);
    const employee = yield employeeRepository.update(req.params.id, { name: req.body.name });
...
employeeRouter.put("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const employeeRepository = data_source_1.default.getRepository(employee_entity_1.default);
    const emp = yield employeeRepository.findOneBy({ email: req.body.email });
    const employee = yield employeeRepository.save(emp);
